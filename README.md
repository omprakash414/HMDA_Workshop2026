...
This repository contains the hands-on commands, workflows, scripts, and analysis pipelines used in the **5 Days Hands-On Workshop on Human Microbiome Data Analysis (11th–15th May 2026)** conducted for delegates from **All India Institute of Ayurveda (AIIA), Delhi**. The workshop covers practical workflows for analyzing microbiome data from both **16S rRNA sequencing** and **Whole Genome Shotgun (WGS) metagenomics** datasets.
...
* Dr. Tarini Shankar Ghosh
 (Assistant Professor, Department of Computational Biology, IIIT-Delhi)
